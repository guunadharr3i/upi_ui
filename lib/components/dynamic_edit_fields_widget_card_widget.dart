...
import 'dynamic_edit_fields_widget_card_model.dart';
export 'dynamic_edit_fields_widget_card_model.dart';

class DynamicEditFieldsWidgetCardWidget extends StatefulWidget {
  const DynamicEditFieldsWidgetCardWidget({
    super.key,
    this.dataTableNewModal,
    required this.closeIconCallBack,
    required this.searchIconCallBack,
  });
  ...
  @override
  State<DynamicEditFieldsWidgetCardWidget> createState() =>
      _DynamicEditFieldsWidgetCardWidgetState();
}

class _DynamicEditFieldsWidgetCardWidgetState
    extends State<DynamicEditFieldsWidgetCardWidget> {
  late DynamicEditFieldsWidgetCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DynamicEditFieldsWidgetCardModel());
                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (context, itemsListIndex) {
                              ...
                              return EditableFieldWidget(
                                key: Key(
                                    'Keyajx_${itemsListIndex}_of_${itemsList.length}'),
