              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: custom_widgets.PaginationWithDots(
                    width: 450.0,
                    height: 45.0,
                    indexFull: _model.pages!,
                    listttt: (indexSelected) async {
                      _model.searchApiPaged = await TablesGetApiCallCall.call(
                        tableCode: () {
                          if (widget!.parameter1 == '2') {
                            return 'UPIHOST';
                          } else if (widget!.parameter1 == '3') {
                        ...
                        filterValue: _model.searchCompModel.textController.text,
                        operator: 'LIKE',
                      );
