...
class AddDeleteRecordsListWidget extends StatefulWidget {
  const AddDeleteRecordsListWidget({
    super.key,
  ...
  @override
  State<AddDeleteRecordsListWidget> createState() =>
      _AddDeleteRecordsListWidgetState();
}

class _AddDeleteRecordsListWidgetState
    extends State<AddDeleteRecordsListWidget> {
  late AddDeleteRecordsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDeleteRecordsListModel());
