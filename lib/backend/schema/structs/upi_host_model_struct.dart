...
class UpiHostModelStruct extends BaseStruct {
  UpiHostModelStruct({
    int? id,
    int? connectTimeout,
    String? enableProxy,
  ...
  int? _maxConnections;
  int get maxConnections => _maxConnections ?? 0;
  set maxConnections(int? val) => _maxConnections = val;

  void incrementMaxConnections(int amount) =>
      maxConnections = maxConnections + amount;

  bool hasMaxConnections() => _maxConnections != null;

  // "MAX_PER_ROUTE" field.
  int? _maxPerRoute;
  int get maxPerRoute => _maxPerRoute ?? 0;
  set maxPerRoute(int? val) => _maxPerRoute = val;

  void incrementMaxPerRoute(int amount) => maxPerRoute = maxPerRoute + amount;
  ...
  static UpiHostModelStruct fromMap(Map<String, dynamic> data) =>
      UpiHostModelStruct(
        ...
        maxConnections: castToType<int>(data['MAX_CONNECTIONS']),
        maxPerRoute: castToType<int>(data['MAX_PER_ROUTE']),
  ...
  static UpiHostModelStruct? maybeFromMap(dynamic data) => data is Map
      ? UpiHostModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static UpiHostModelStruct fromSerializableMap(Map<String, dynamic> data) =>
      UpiHostModelStruct(
        id: deserializeParam(
          data['ID'],
          ParamType.int,
  ...
  @override
  String toString() => 'UpiHostModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is UpiHostModelStruct &&
        id == other.id &&
...
UpiHostModelStruct createUpiHostModelStruct({
  int? id,
  int? connectTimeout,
  String? enableProxy,
  String? host,
